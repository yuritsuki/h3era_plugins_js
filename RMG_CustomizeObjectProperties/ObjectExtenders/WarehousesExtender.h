...
namespace warehouses
{
    ...
    class WarehousesExtender final
        : public extender::ObjectExtender
    {
      ...
      private:
        ...
        virtual void* GetSetupFromMapItem(H3MapItem* mapItem) const noexcept override final;
        ...
        virtual int AI_OnScouting_Value() const noexcept override final;
